...
# Install AzCopy v10
RUN curl -L https://aka.ms/downloadazcopy-v10-linux > azcopyv10.tar.gz \
 && mkdir azcopy \
 && tar xvzf azcopyv10.tar.gz --strip=1 \
...
# RUN azcopy --source https://vstsagenttools.blob.core.windows.net/tools/hostedtoolcache/linux --recursive=true --destination $AGENT_TOOLSDIRECTORY
